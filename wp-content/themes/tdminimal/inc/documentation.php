		...
		<table id="td-documenation" class="form-table widefat">
			<thead>
				<tr>
					...
					<ol>
						...
						<li><a href="#add-home-templates">How to change a Home Template?</a></li>
						...
						<li><a href="#add-archive-page">How to add Custom Archive Pages?</a></li>
			...
			<tbody>
				...
				<tr valign="top">
 				...
 				<tr valign="top">
 					<td>
 						<h2 id="add-home-templates">How to change a Home Template?</h2>
						<br>
